...
export default function VideoAnalyzer() {
  ...
  return (
    <div style={{ 
      ...
      <h1 style={{ color: '#000000' }}>AI Exercise Video Analyzer</h1>
      <p style={{ color: '#666666', marginBottom: '20px', fontSize: '16px' }}>
        Upload any exercise video and our AI will automatically detect the movement and provide detailed form analysis!
      </p>
      ...
      {isLoading && (
        <div style={{ textAlign: 'center', marginBottom: '20px', color: '#000000' }}>
          ...
          <p style={{ color: '#000000' }}>Analyzing your exercise video...</p>
        </div>
      )}
